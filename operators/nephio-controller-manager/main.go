...
import (
	...
	reconciler "github.com/nephio-project/nephio/controllers/controllers/reconcilers/reconcilerinterface"
	"os"
...
func run(ctx context.Context) error {
	...
	for name, r := range reconciler.Reconcilers {
		...
		if _, err = r.SetupWithManager(mgr, reconciler.ControllerConfig{
