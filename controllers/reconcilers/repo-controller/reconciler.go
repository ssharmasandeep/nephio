...
import (
	...
	controllers "github.com/nephio-project/nephio/controllers/controllers/reconcilers/reconcilerinterface"
...
func (r *reconciler) SetupWithManager(mgr ctrl.Manager, i interface{}) (map[schema.GroupVersionKind]chan event.GenericEvent, error) {
	...
	r.giteaClient = i.(controllers.ControllerConfig).GiteaClient
